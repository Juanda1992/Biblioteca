...
<head>
    ...
    <header>
      ...
      <div class="text align-center">
        <nav class="navbar navbar-dark bg-dark" style="text-align:center !important; display:block; " >
          <a class="navbar-brand" href=""><h1>Biblioteca Digital</h1></a>
        </nav>
      </div>
  ...
  <div class="container">
    <form action="registrarProducto.php" method="POST">
      ...
      <div class="row">
        <div class="col">
          <input type="text" class="form-control" placeholder="Titulo del libro" name ="producto">
        </div>

        <div class="col">
          <input type="text" class="form-control" placeholder="Editorial del libro" name ="marca" >
        </div>
